...
namespace Janelia
{
    public class SocketReader
    {
        ...
        // HEY!! Only TCP needs `connectRetryMs`.
        public SocketReader(string hostname = "127.0.0.1", int port = 2000, int connectRetryMs = 5000, int readBufferSizeBytes = 1024, int readBufferCount = 240, bool useUDP = true)
        {
            usingUDP = useUDP;
            _hostname = hostname;
            _port = port;
        ...
        private void ThreadFunctionUDP()
        {
            ...
            // use the lower-level `Socket` approacy.
            Socket socket;

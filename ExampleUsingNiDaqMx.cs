...
// 3. Set "Main Camera" to have position [5, 0, 0] and rotation [0, -90, 0].
// 4. Attach the NI DAQ device.
// 5. Run the game.
// 6. When the application is running, the cylinder should rotate based on the inputs
// "Dev1/ai0" and "Dev1/ai3".
// 7. And pressing any key should write a value to outputs "Dev1/ao0" and "Dev1/ao1".
// The value alternates between three values: 0, the configured minimum voltage (-5),
// and the configured maximum (7).
// 8. Check the "Show Each Read Write" box on the cylinder to get more details of
// the DAQ device communication in the editor console.
// 9. When running as a stand-alone application, pressing the escape key quits the application.
